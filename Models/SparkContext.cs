...
namespace  STW_DevExpress_Demo.Models
{
    public partial class SparkContext : DbContext
    {
        ...
        public virtual DbSet<OdataDemo> OdataDemo { get; set; }
...
//                optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=Spark;Trusted_Connection=True;");
//            }
        }
